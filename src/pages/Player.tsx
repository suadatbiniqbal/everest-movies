...
const Player: React.FC = () => {
  ...
  const getPlayerUrl = () => {
    if (type === 'movie') {
      return `https://tmdbplayer.nunesnetwork.com/?type=movie&id=${id}&server=1`;
    } else {
      return `https://tmdbplayer.nunesnetwork.com/?type=tv&id=${id}&season=${season}&episode=${episode}&server=1`;
    }
  };
